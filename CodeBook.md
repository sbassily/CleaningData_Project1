...
A data.table named `tidyDataMean` is set with the following columns. tidyAvg.txt file is written from run_analysis.R.
...
A data.table named `tidyData` is set with the following columns.  tidy.txt file is written from run_analysis.R.
